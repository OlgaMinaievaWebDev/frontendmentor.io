function Result() {
 return (
  <div className="w-full md:w-1/2 bg-gradient-to-b from-indigo-600 to-indigo-800 text-white text-center p-12 md:rounded-3xl flex flex-col items-center justify-center gap-4 rounded-b-3xl">
